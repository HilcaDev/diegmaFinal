            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td class="text-center d-flex">
                        <a href="editar.jsp?id=<%= rs.getInt("id")%>" class="btn btn-primary btn-sm p-2 m-2" >Editar</a>
                        <a href="eliminar.jsp?id=<%= rs.getInt("id")%>" class="btn btn-outline-primary btn-sm p-2 m-2" >Eliminar</a>
                    </td>
                </tr>
                <%}%>
            </table>
