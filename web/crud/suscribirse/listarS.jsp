    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-end">
                <a class="btn btn-success btn-lg m-1" href="agregarS.jsp">Nuevo Registro</a>
                <a class="btn btn-outline-success btn-lg m-1" href="../../admin.jsp">Regresar</a>
            </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="editarS.jsp?codigo=<%= rs.getInt("cod_usuario")%>" class="btn btn-primary btn-sm p-2 m-2" >Editar</a>
                        <a href="eliminarS.jsp?codigo=<%= rs.getInt("cod_usuario")%>" class="btn btn-outline-primary btn-sm p-2 m-2" >Eliminar</a>
                    </td>
                </tr>
                <%}%>
            </table>
